        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            ...
            <button
              ...
              className="font-medium text-cyan-500 hover:text-cyan-600 dark:text-teal-400 dark:hover:text-teal-300 focus:outline-none transition-colors"
            >
                ...
                <motion.div variants={itemVariants} className="space-y-6">
                  <div>
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-neutral-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm dark:bg-neutral-700 dark:text-white dark:placeholder-gray-400"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <input
                          ...
                          name="remember-me"
                          type="checkbox"
                          className="h-4 w-4 text-cyan-500 focus:ring-cyan-500 border-gray-300 rounded dark:bg-neutral-700 dark:border-neutral-600"
                        />
                      ...
                      <div className="text-sm">
                        <a href="#" className="font-medium text-cyan-500 hover:text-cyan-600 dark:text-teal-400 dark:hover:text-teal-300">
                  ...
                  <div>
                    <button
                      type="submit"
                      disabled={loading}
                      className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-cyan-500 hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 transition-colors duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                        {loading ? (
                          ...
                          <FiArrowRight className="h-5 w-5 text-cyan-200 group-hover:text-cyan-100" />
                        )}
                      </span>
                      {loading
