      ...
      <div className="text-center mb-16">
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`${isDarkMode ? 'bg-neutral-800 border-neutral-600' : 'bg-white border-black'} border-2 rounded-lg p-8`}>
            <div className={`w-32 h-32 ${isDarkMode ? 'bg-neutral-700' : 'bg-gray-200'} rounded-full mx-auto mb-6 flex items-center justify-center`}>
              <HiOutlineUserCircle className={`${isDarkMode ? 'text-gray-300' : 'text-gray-600'} w-16 h-16`} />
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 text-center">
              <div className={`${isDarkMode ? 'bg-neutral-700' : 'bg-gray-50'} p-4 rounded-lg`}>
                <div className="flex items-center justify-center mb-2">
                  <HiOutlineChartBar className="w-7 h-7 text-cyan-500" />
                </div>
              ...
              <div className={`${isDarkMode ? 'bg-neutral-700' : 'bg-gray-50'} p-4 rounded-lg`}>
                <div className="flex items-center justify-center mb-2">
                  <HiOutlineCog6Tooth className="w-7 h-7 text-cyan-500" />
                </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center group">
            ...
            <p className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>
              We work as your technology partner not just a vendor. Your success is the key.
            </p>
          </div>
          <div className="text-center group">
            <div className="bg-cyan-500 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform shadow-lg">
          ...
          <div>
            ...
            <ul className={`space-y-3 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              <li className="flex items-start gap-2">
                <HiOutlineCheckCircle className="w-5 h-5 text-cyan-500 flex-shrink-0 mt-0.5" />
